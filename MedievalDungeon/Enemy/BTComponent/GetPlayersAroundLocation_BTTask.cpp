...
#include "GetPlayersAroundLocation_BTTask.h"

#include "../EnemyParent.h"
#include "../EnemyControllerParent.h"

UGetPlayersAroundLocation_BTTask::UGetPlayersAroundLocation_BTTask()
{
	NodeName = TEXT("UGetPlayersAroundLocation_BTTask");
}

EBTNodeResult::Type UGetPlayersAroundLocation_BTTask::ExecuteTask(UBehaviorTreeComponent &OwnerComp, uint8* NodeMemory)
{
